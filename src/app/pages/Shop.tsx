    ...
    <div className="bg-gray-50">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Exclusion Note */}
          <div className="mt-8 bg-amber-50 border border-amber-200 rounded-lg p-4 max-w-3xl mx-auto">
            <p className="text-sm text-amber-900">
              <strong>{t.shop.faq.exclusionNote}</strong>
            </p>
          </div>

          {/* Feature Comparison Note */}
          <div className="mt-8 bg-white rounded-xl p-6 border border-gray-200 max-w-3xl mx-auto">
